...
import { MapPin, Loader2, LayoutGrid, LayoutList, Image as ImageIcon } from 'lucide-react';
...
export default function AccountantSpacesPage() {
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Просмотр торговых мест рынка</p>
                </div>
            ...
            {spaces.length === 0 ? (
                    ...
                    <CardContent>
                        <div className="space-y-2">
                            ...
                            {spaces.map((space) => (
                                <Link
                                    key={space.id}
                                    href={`/accountant/spaces/${space.id}`}
                                    className="grid grid-cols-5 gap-4 px-4 py-3 border rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors items-center cursor-pointer"
                                >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                    {spaces.map((space) => (
                        <Link key={space.id} href={`/accountant/spaces/${space.id}`} className="block group">
