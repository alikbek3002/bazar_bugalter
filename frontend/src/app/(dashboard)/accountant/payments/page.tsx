        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Управление платежами по аренде</p>
                </div>
                <Link href="/accountant/payments/new">
                    <Button>
                        ...
                        <div className="space-y-2">
                            ...
                            {payments.map((payment) => (
                                ...
                                >
                                    ...
                                    <div className="text-muted-foreground">{payment.space?.code || payment.contract?.space?.code || '—'}</div>
